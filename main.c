...
int main()
{
     struct cars c1={"bmw m series","bmw",5000000,2369,2003};
           printf("name:%s\n",c1.name);
           printf("model:%s\n",c1.model);
           printf("prize:%2f\n",c1.prize);
           printf("cc:%d\n",c1.cc);
           ...
           struct cars c2={"tata","nano",508598,2485,2008};
               printf("name:%s\n",c2.name);
               printf("model:%s\n",c2.model);
           ...
           struct cars c3={"maruthi","suzuki",5655951,2548,2002};
               printf("name:%s\n",c3.name);
               printf("model:%s\n",c3.model);
           ...
           struct cars c4={"honda","civic",5548488,8655,2007};
               printf("name:%s\n",c4.name);
               printf("model:%s\n",c4.model);
